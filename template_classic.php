...
<body>
  ...
  <div class="resume" id="resumeContent">
    ...
    <section>
      <h2>Education</h2>
      <ul>
        <li><strong>10th:</strong> <?= htmlspecialchars($resume['school_10']) ?> - <?= htmlspecialchars($resume['marks_10']) ?>%</li>
        <li><strong>12th:</strong> <?= htmlspecialchars($resume['school_12']) ?> - <?= htmlspecialchars($resume['marks_12']) ?>%</li>
        <li><strong>Degree:</strong> <?= htmlspecialchars($resume['Degree']) ?> from <?= htmlspecialchars($resume['Collage_name']) ?> - <?= htmlspecialchars($resume['Degree_per']) ?>%</li>
      </ul>
    </section>
