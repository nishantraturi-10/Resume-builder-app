...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO resume (name, email, marks_10,marks_12, Degree , Degree_per, exp, skills ,resume_id,address , Collage_name,template_id,profile_details, contact,school_10, school_12,lang,Gender,profile_image)
            VALUES ('$name', '$email', '$Marks_10', '$Marks_12','$Degree','$Degree_Percentage ','$experience', '$skills','$resume_id','$address','$Collage_name','$template_id','$about','$phn_number','$school_10','$school_12','$language','$Gender','$photo')";
